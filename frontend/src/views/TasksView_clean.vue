              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-4 text-sm text-gray-500">
                    ...
                    <span v-if="task.assigned_to_user" class="text-blue-600 font-medium">
                    ...
                    >
                      <div class="py-1">
                        ...
                        <div class="px-4 py-1 text-xs text-gray-500 border-b">
                          Debug: Creator={{ task.user_id }}, Current={{ getCurrentUser().id }}
                        </div>
                        ...
                        <!-- Edit/Delete options - always visible for debugging -->
                        <button
                          @click="editTask(task)"
                          class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                        >
